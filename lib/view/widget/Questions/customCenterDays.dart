...
class CustomCenterDays extends GetView<QuestionDaysController> {
  final String txt1;
  final String txt2;
  final void Function() onPressed;
  final void Function() onPressed2;
  const CustomCenterDays({super.key, required this.txt1, required this.onPressed, required this.txt2, required this.onPressed2});
            ...
            child: Column(
              ...
              if(controller.index== controller.data.length)
                   ElevatedButton(
                    ...
                    onPressed: (){
                     Get.offNamed(RoutesApp.resultdayspage);
