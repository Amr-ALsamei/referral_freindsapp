...
class CustomCenterLevel extends GetView<QuestionsController> {
  final String txt1;
  final String txt2;
  final void Function() onPressed;
  final void Function() onPressed2;
  const CustomCenterLevel({super.key, required this.txt1, required this.onPressed, required this.txt2, required this.onPressed2});
