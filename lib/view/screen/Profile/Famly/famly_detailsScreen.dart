...
import 'package:referral_freindsapp/controller/QuestionFamly/details_controller.dart';
import 'package:referral_freindsapp/core/constant/colors.dart';

class FamlyDetailsScreen extends StatelessWidget {
  const FamlyDetailsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    FamlyDetailsExamController controller=Get.put(FamlyDetailsExamController());
    return Scaffold(
