...
import 'package:referral_freindsapp/controller/videofavorite_controller.dart';
...
class VideoFavoriteScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    VideoFavoriteController controller=Get.put(VideoFavoriteController());
    return Scaffold(
      appBar: AppBar(
        title: const Text('صفحة المفضلة'),
      ),
      body:GetBuilder<VideoFavoriteController>(builder: (controller)=> Column(
        children: [
      ...
      floatingActionButton: GetBuilder<VideoFavoriteController>(builder: (controller)=>FloatingActionButton(
        onPressed: (){
