...
import 'package:referral_freindsapp/controller/detailstochildren_controller.dart';
import 'package:referral_freindsapp/core/constant/colors.dart';
import 'package:referral_freindsapp/core/constant/imageAssest.dart';

class DetailsChildrenScreen extends StatelessWidget {
  const DetailsChildrenScreen({super.key});

  @override
  Widget build(BuildContext context) {
    ChildrenDetailsExamController controller=Get.put(ChildrenDetailsExamController());
    return Scaffold(
