...
import 'package:referral_freindsapp/view/widget/Questions/customCenterlevel.dart';
...
class QuestionsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: GetBuilder<QuestionsController>(builder: (controller)=>controller.index != controller.data.length? FloatingActionButton(
      ...
      child: GetBuilder<QuestionsController>(
        builder: (controller)=>HandlingDataView(
          ...
          ?CustomCenterLevel(txt1: "مبروك لقد حصلت في المستوى الاول على درجة قدرها:\n${controller.responsescore}",
           onPressed: (){
            ...
            ?CustomCenterLevel(txt1: "مبروك لقد حصلت في المستوى الثاني على درجة قدرها:\n${controller.responsescore}",
           onPressed: (){
            ...
            ?CustomCenterLevel(txt1: "مبروك لقد حصلت في المستوى الثالث على درجة قدرها:\n${controller.responsescore}",
           onPressed: (){
