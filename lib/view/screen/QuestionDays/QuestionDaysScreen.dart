...
import 'package:referral_freindsapp/view/widget/Questions/customCenterDays.dart';
import 'package:video_player/video_player.dart';

class QuestionDaysScreen extends StatelessWidget {
  const QuestionDaysScreen({super.key});

  @override
  Widget build(BuildContext context) {
    // ignore: unused_local_variable
    QuestionDaysController controller=Get.find();
    return Scaffold(
      floatingActionButton: GetBuilder<QuestionDaysController>(builder: (controller)=>controller.index != controller.data.length? FloatingActionButton(
      ...
      child: GetBuilder<QuestionDaysController>(
        builder: (controller)=>HandlingDataView(
          statusRequest: controller.statusRequest, 
          widget: controller.index == controller.data.length
            ?CustomCenterDays(txt1: "مبروك لقد حصلت  على درجة قدرها:\n${controller.responsescore}",
           onPressed: (){
        ...
        children: [
  /////////////////////////////////////////////////////////////////////
    GetBuilder<QuestionDaysController>(builder: (controller)=> Column(
        children: [
                    ...
                    children: [
                      InkWell(
                        ...
                        borderRadius: BorderRadius.circular(20)
                                            ...
                                            child: Text(controller.data[controller.index!].questionOption1!,style: const TextStyle(fontSize: 20,fontWeight: FontWeight.bold),)),
                      ),
                     InkWell(
                      onTap: (){
                        int i=controller.index!;
                       ...
                       padding: const EdgeInsets.symmetric(horizontal: 40),
                        ...
                        borderRadius: BorderRadius.circular(20)
                                           ...
                                           child: Text(controller.data[controller.index!].questionOption2!,style: const TextStyle(fontSize: 20,fontWeight: FontWeight.bold))),
                     ),
                       ...
                       InkWell(
                        onTap: (){
                         ...
                         borderRadius: BorderRadius.circular(20)
                                             ...
                                             child: Text(controller.data[controller.index!].questionOption3!,style: const TextStyle(fontSize: 20,fontWeight: FontWeight.bold))),
                       ),
                     InkWell(
                      onTap: (){
                        int i=controller.index!;
                       ...
                       padding: const EdgeInsets.symmetric(horizontal: 40),
                        ...
                        borderRadius: BorderRadius.circular(20)
                                           ...
                                           child: Text(controller.data[controller.index!].questionOption4!,style: const TextStyle(fontSize: 20,fontWeight: FontWeight.bold))),
                     ),
