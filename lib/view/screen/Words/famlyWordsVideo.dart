...
import 'package:referral_freindsapp/controller/Words/famlyvideo_controller.dart';
import 'package:referral_freindsapp/core/constant/colors.dart';
import 'package:video_player/video_player.dart';

class FamlyWordsVideoScreen extends StatelessWidget {
  const FamlyWordsVideoScreen({super.key});

  @override
  Widget build(BuildContext context) {
    // ignore: unused_local_variable
    FamlyWordsVideoController controller=Get.put(FamlyWordsVideoController());
    return Scaffold(
      appBar: AppBar(
        title: const Text('صفحة تعلم الكلمات'),
      ),
      body:GetBuilder<FamlyWordsVideoController>(builder: (controller)=> Column(
        children: [
      ...
      floatingActionButton: GetBuilder<FamlyWordsVideoController>(builder: (controller)=>FloatingActionButton(
        onPressed: (){
