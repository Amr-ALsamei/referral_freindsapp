...
import 'package:referral_freindsapp/controller/Words/weekvideo_controller.dart';
import 'package:referral_freindsapp/core/constant/colors.dart';
import 'package:video_player/video_player.dart';

class WeekWordsVideoScreen extends StatelessWidget {
  const WeekWordsVideoScreen({super.key});

  @override
  Widget build(BuildContext context) {
    // ignore: unused_local_variable
    WeekWordsVideoController controller=Get.put(WeekWordsVideoController());
    return Scaffold(
      appBar: AppBar(
        title: const Text('صفحة تعلم الكلمات'),
      ),
      body:GetBuilder<WeekWordsVideoController>(builder: (controller)=> Column(
        children: [
      ...
      floatingActionButton: GetBuilder<WeekWordsVideoController>(builder: (controller)=>FloatingActionButton(
        onPressed: (){
