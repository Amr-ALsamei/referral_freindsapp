...
import 'package:referral_freindsapp/controller/Words/video_controller.dart';
import 'package:referral_freindsapp/core/constant/colors.dart';
import 'package:video_player/video_player.dart';

class WordsVideoScreen extends StatelessWidget {
  const WordsVideoScreen({super.key});

  @override
  Widget build(BuildContext context) {
    // ignore: unused_local_variable
    WordsVideoController controller=Get.put(WordsVideoController());
    return Scaffold(
      appBar: AppBar(
        title: const Text('صفحة تعلم الكلمات'),
      ),
      body:GetBuilder<WordsVideoController>(builder: (controller)=> Column(
        children: [
      ...
      floatingActionButton: GetBuilder<WordsVideoController>(builder: (controller)=>FloatingActionButton(
        onPressed: (){
