...
import 'package:referral_freindsapp/view/widget/Questions/customCentersentence1.dart';
import 'package:video_player/video_player.dart';

class QuestionSentenceScreen extends StatelessWidget {
  const QuestionSentenceScreen({super.key});

  @override
  Widget build(BuildContext context) {
    // ignore: unused_local_variable
    QuestionSentenceController controller=Get.find();
    return Scaffold(
      floatingActionButton: GetBuilder<QuestionSentenceController>(builder: (controller)=>controller.index != controller.data.length? FloatingActionButton(
      ...
      child: GetBuilder<QuestionSentenceController>(
        builder: (controller)=>HandlingDataView(
          statusRequest: controller.statusRequest, 
          widget: controller.index == controller.data.length
            ?CustomCenterSentence1(txt1: "مبروك لقد حصلت  على درجة قدرها:\n${controller.responsescore}",
           onPressed: (){
        ...
        children: [
  /////////////////////////////////////////////////////////////////////
    GetBuilder<QuestionSentenceController>(builder: (controller)=> Column(
        children: [
